...
// Flag to show one-time legal text for 4-month period adjustment
const SHOW_LEGAL_TEXT_ADDITION = true;
...
export function renderPreCommitmentPage(
  ...
  <div class="page">
    ...
    <p style="margin-top: -5px;">If you would like to have your pre-commitment statement produced in another language please contact SkyCity Adelaide's Rewards department either at the Rewards desks onsite or by emailing <a href="mailto:customercompliance@skycity.com.au" style="color: #0066cc; text-decoration: underline;">customercompliance@skycity.com.au</a>.</p>
