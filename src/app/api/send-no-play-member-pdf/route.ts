...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      const subject = `Your SkyCity No-Play Pre-Commitment Statement - ${statementPeriod}`;
      ...
      const msg = {
        ...
        subject: subject,
        text: `Dear ${playerName},\n\nPlease find attached your No-Play Pre-Commitment statement for ${statementPeriod}.\n\nThank you for being a valued member of SkyCity.\n\nBest regards,\nSkyCity Team`,
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <h2 style="color: #1a1a1a;">Dear ${playerName},</h2>
            <p>Please find attached your No-Play Pre-Commitment statement for <strong>${statementPeriod}</strong>.</p>
